		...
		return this.each(function() {
			...
			if (findnav) {
				...
				if(p.buttonicon.toString().toUpperCase() === "NONE") {
				    $(tbd).addClass('ui-pg-button ui-corner-all ' + p.class).append("<div class='ui-pg-div'>" + p.caption + "</div>");
				} else	{
				    $(tbd).addClass('ui-pg-button ui-corner-all ' + p.class).append("<div class='ui-pg-div'><span class='ui-icon " + p.buttonicon + "'></span>" + p.caption + "</div>");
				}
